     ...
     <li id="lixeira-menu">Lixeira <?php if($CNT_LX != 0): echo "($CNT_LX)"; endif; ?></li>
			...
			<section id="publicar-noticia">
				...
				<section id="publicar-noticia-left">
					...
					<tbody>
						<tr>
							<td><input type="text" name="titulo-noticia" value="<?php echo $tiulo_ntE; ?>" /></td>
						</tr>
						<tr>
						...
						<section id="publicar-nota-informacoes">
							...
							<table>
								<tbody>
									...
									<tr>
										<td>
											<input type="text" id="imagem-noticia-carregar"  value="<?php echo $imagem_ntE ?>"  />
              	...
              	<table cellpadding="0" cellspacing="0">
                	<tbody>
                        ...
                        <?php 
                            ...
                            $SQL_TDN = mysql_query("SELECT id_noticia, titulo, dataPub, autorPub, tags, nome_categoria FROM noticias INNER JOIN categoria ON (noticias.categoria = categoria.id_categoria) WHERE status = 1");
              	...
              	<table cellpadding="0" cellspacing="0">
                	<tbody>
                        ...
                        <?php 
                            ...
                            $SQL_TDN = mysql_query("SELECT id_noticia, titulo, dataPub, autorPub, tags, nome_categoria FROM noticias INNER JOIN categoria ON (noticias.categoria = categoria.id_categoria) WHERE status = 0");
              	...
              	<table cellpadding="0" cellspacing="0">
                	<tbody>
                        ...
                        <?php 
                            ...
                            $SQL_TDN = mysql_query("SELECT id_noticia, titulo, dataPub, autorPub, tags, nome_categoria FROM noticias INNER JOIN categoria ON (noticias.categoria = categoria.id_categoria) WHERE status = 2");
